...
def main(offset):
    ...
    f = open('1.csv', mode='a', encoding='utf-8-sig', newline='')
    csv_writer = csv.DictWriter(f, fieldnames=['链家编号','小区名称','所在区域','总价','单价','房屋户型','所在楼层','建筑面积',
    ...
    for i in range(10000000):
        ...
        response = requests.get(url=url, headers=hds[i%12])
